...
Two files per week of the 24-week build:
- **`weekN.md`** — what was built that week, what happened, files touched, checkpoints met.
- **`learningsN.md`** — the concepts behind that week + interview-ready takeaways and a self-test.

| Week | Topic | Report | Learnings | Status |
|------|-------|--------|-----------|--------|
...
| 6 | Go, goroutines, cgo/gRPC | [week6.md](week6.md) | [learnings6.md](learnings6.md) | ✅ |
